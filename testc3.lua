...
return (function(...)
	...
	if willClone then
		...
		fakeCharacter:SetAttribute("IsFake", true)
		
		camera.CameraSubject = fakeCharacter:FindFirstChildOfClass("Humanoid")
		
		return fakeCharacter
	else
		fakeCharacter = Players:CreateHumanoidModelFromDescription(
			realChar.Humanoid:FindFirstChild("HumanoidDescription") or Instance.new("HumanoidDescription"),
			rigType
		)
