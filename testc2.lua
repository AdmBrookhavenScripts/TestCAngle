...
if not supportedplace then
	if _G["Fallback prompt"] == false then
		return loadstring(game:HttpGet("https://github.com/AdmBrookhavenScripts/TestCAngle/raw/refs/heads/main/testc1.lua"))()
	end
	loadstr(game:HttpGet("https://github.com/AdmBrookhavenScripts/TestCAngle/raw/refs/heads/main/testc1.lua"))
	return
end
